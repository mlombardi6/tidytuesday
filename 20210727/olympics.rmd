...
# dolympics <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2021/2021-07-27/olympics.csv')
dt_olympics <- data.table(readRDS("~/Documents/R/dev/tidyTuesday_private/20210727/dolympics.rds"))
```
